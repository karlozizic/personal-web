  ...
  return (
    ...
    className = "text-white absolute  top-0 left-0 w-full h-full bg-grey2 lg:px-48 px-20">
      ...
      <main className="my-80 text-center p-10 md:px-20 lg:px-40px">
        <div>
          <h2 className='text-5xl py-2 text-black2 font-medium md:text-6xl'>Karlo Zizic</h2>
        ...
        <div className='relative mx-auto bg-gradient-to-b from-greenc-400 rounded-t-2xl w-80 h-80 mt-20 md:h-80 md:w-80'>
